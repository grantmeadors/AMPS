...
ylolist = 1e-6*[1.e-23 6.e-23 1.e-23 1.e-23 1.e-23];
yhilist = [1.e-21 5.e-21 1.e-21 1.e-21 1.e21];
bandnames = ['40_2000_Hz ';'40_70_Hz   ';'70_700_Hz  ';'200_2000_Hz'; '119_121_Hz '];
% 1 = linear-linear, 2 = linear-log, 3 = log-linear, 4 = log-log
plottypelist = [4 2 2 4 2];
...
%  for iifo = 1:length(ifolist) 
  for iifo = 1:1
     ...
     %aimppsd{irun,iifo} = resample(data1(:,3) - data2(:,3), 1, 32, 100);
